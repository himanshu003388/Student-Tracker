...
[![License](https://img.shields.io/badge/License-MIT-0088cc?style=flat-square)](./LICENSE)
...
*   **Visual Habit Calendar:** Track daily habit completion status throughout the month.
*   **Streak Tracking:** Motivation system with pulsing fire badge animations to reward consistency.
*   **Target Milestones:** Separate weekly and monthly target checklists.
*   **Concentric Progress Rings:** Beautiful dual-ring SVG visualization showing your weekly and monthly habit milestones at a glance.

### 💰 Expense & Budget Manager
*   **Financial Health Stats:** Track Income, Expense, Net Balance, and monthly savings.
...
*   **Zero Theme Flicker:** Light/Dark theme configuration persists via LocalStorage and renders instantly prior to DOM load.
...
Get your workspace up and running in seconds. No builds, no server dependencies, no installations.

```bash
# 1. Clone the project
git clone https://github.com/himanshu003388/Student-Tracker.git
...
<div align="center">
Made with ❤️ by <b>Himanshu</b>

*If this project helped you organize your student life, please consider giving it a ⭐ on GitHub!*
</div>
